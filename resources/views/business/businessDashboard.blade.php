        ...
        <div class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-primary"
                            style="padding: 0.75rem 1.5rem; background: linear-gradient(135deg, #4f46e5, #7c3aed); color: white; border: none; border-radius: 8px; font-weight: 600; cursor: pointer;">
                            + Add New Order
                        </button>
                    </div>
                    <table>
                ...
                <div class="mc">
                    ...
                    <form method="POST" action="/products/store" enctype="multipart/form-data">
                        ...
                        <div class="fg">
                            ...
                            <input type="text" name="name" placeholder="e.g., Fresh Apples" required>
                        </div>
                        ...
                        <div class="gr">
                            <div class="fg">
                                <label>Price (₹) *</label>
                                <input type="number" step="0.01" name="price" placeholder="120" required>
                            </div>
            ...
            <div class="tab-content" id="profile-content">
                <div class="card">
                    <div class="card-header" style="display:flex; align-items:center; gap:1rem;">
                        ...
                        <!-- Enterprise Logo -->
                        <img id="enterpriseLogo" src="" alt="Enterprise Logo" style="
                                width:64px;
                                height:64px;
                                border-radius:12px;
                                object-fit:cover;
            ...
            <div class="tab-content" id="enterprise-content">
                <div class="card">
                    ...
                    <div style="padding: 2rem;">
                        ...
                        <div
                            style="background: linear-gradient(135deg, #4f46e5, #7c3aed); padding: 2rem; border-radius: 16px; margin-bottom: 2rem; color: white;">
                            <div style="display: flex; align-items: center; gap: 1.5rem;">
                                <div style="font-size: 4rem;">🏢</div>
                                <div>
                                    <h3 style="font-size: 1.75rem; font-weight: 800; margin-bottom: 0.5rem;">Upgrade to
                                        Enterprise</h3>
                                    <p style="opacity: 0.9; line-height: 1.6;">
                                        Get access to advanced features including multi-location management, bulk
                                        operations, priority support, and detailed analytics.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div
                                style="padding: 1.5rem; background: var(--light-gray); border-radius: 12px; text-align: center;">
                                <div style="font-size: 2.5rem; margin-bottom: 0.5rem;">📍</div>
                                <h4 style="font-weight: 700; margin-bottom: 0.5rem;">Multi-Location</h4>
                                <p style="color: var(--gray); font-size: 0.9rem;">Manage multiple business locations
                            ...
                            <div
                                ...
                                <p style="color: var(--gray); font-size: 0.9rem;">Detailed insights and custom reports
                                </p>
                            </div>
                            <div
                                style="padding: 1.5rem; background: var(--light-gray); border-radius: 12px; text-align: center;">
                        ...
                        <form id="enterpriseForm" enctype="multipart/form-data"
                            style="max-width: 800px; margin: 0 auto;">
                            <h3 style="font-size: 1.5rem; font-weight: 800; margin-bottom: 2rem; color: var(--dark);">
                                Enterprise Registration Form</h3>

                            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem;">
                                <!-- Company Name -->
                                <div style="grid-column: 1 / -1;">
                                    <label
                                        style="display: block; font-weight: 700; margin-bottom: 0.5rem; color: var(--dark);">
                                        Company Legal Name <span style="color: var(--danger);">*</span>
                                    </label>
                                    <input type="text" name="companyName" placeholder="Enter your company's legal name"
                                        required
                                ...
                                <div>
                                    ...
                                    <input type="text" name="registrationNumber" placeholder="CIN/Registration No."
                                        required
                                        style="width: 100%; padding: 0.875rem; border: 2px solid var(--border); border-radius: 12px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1rem;">
                                </div>
                                <!-- Industry Type -->
                                ...
                                <div>
                                    ...
                                    <input type="text" name="designation" placeholder="e.g., CEO, Director" required
                                        style="width: 100%; padding: 0.875rem; border: 2px solid var(--border); border-radius: 12px; font-family: 'Plus Jakarta Sans', sans-serif; font-size: 1rem;">
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="tel" name="phone" placeholder="10-digit number" pattern="[0-9]{10}"
                                ...
                                <div style="grid-column: 1 / -1;">
                                    ...
                                    <textarea name="address" rows="3" placeholder="Complete registered address" required
                                ...
                                <div style="grid-column: 1 / -1;">
                                    ...
                                    <div
                                        style="padding: 2rem; border: 2px dashed var(--border); border-radius: 12px; text-align: center; background: var(--light-gray);">
                                        <div style="font-size: 2.5rem; margin-bottom: 1rem;">📄</div>
                                        <p style="color: var(--gray); margin-bottom: 1rem;">Upload Enterprise Photo</p>
                                        <input type="file" name="photo" accept=".jpg,.jpeg,.png" required>
                                        <p style="font-size: 0.85rem; color: var(--gray); margin-top: 0.5rem;"> JPG, PNG
                                            (Max 5MB each)</p>
                                    </div>
                                </div>
                                    ...
                                    <label style="display: flex; align-items: center; gap: 0.75rem; cursor: pointer;">
                                        ...
                                        <span style="color: var(--gray);">
                                            I agree to the <a href="#"
                                                style="color: var(--primary); font-weight: 600;">Enterprise Terms &
            ...
            <div class="tab-content" id="revenue-content">
                <div class="card">
                    ...
                    <div style="padding: 2rem;">
                        <div
                            style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 2rem; margin-bottom: 2rem;">
                            <div
                                style="text-align: center; padding: 2rem; background: var(--light-gray); border-radius: 12px;">
                                <div
                                    style="font-size: 2.5rem; font-weight: 900; color: var(--success); margin-bottom: 0.5rem;">
                                    ₹45,231</div>
                            ...
                            <div
                                style="text-align: center; padding: 2rem; background: var(--light-gray); border-radius: 12px;">
                                <div
                                    style="font-size: 2.5rem; font-weight: 900; color: var(--primary); margin-bottom: 0.5rem;">
                                    ₹1,24,567</div>
                            ...
                            <div
                                style="text-align: center; padding: 2rem; background: var(--light-gray); border-radius: 12px;">
                                <div
                                    style="font-size: 2.5rem; font-weight: 900; color: var(--warning); margin-bottom: 0.5rem;">
                                    ₹4,89,230</div>
                                <div style="color: var(--gray); font-weight: 600;">This Year</div>
                            </div>
                        </div>
                        <div
                            style="height: 300px; background: var(--light-gray); border-radius: 12px; display: flex; align-items: center; justify-content: center; color: var(--gray); font-weight: 600;">
            ...
            <div class="tab-content" id="contact-content">
                <div class="card">
                    ...
                    <div style="padding: 2rem;">
                        <div class="help-grid" style="display: grid; grid-template-columns: 1fr 400px; gap: 2rem;">
                            <div class="faq-section">
                                <h4
                                    style="margin-bottom: 1.5rem; border-bottom: 1px solid var(--border); padding-bottom: 0.5rem;">
                                    Frequently Asked Questions</h4>
                                <div class="faq-item" style="margin-bottom: 1rem;">
                                    <h5 style="font-weight: 700; margin-bottom: 0.5rem;">How do I manage my inventory?
                                    </h5>
                                    <p style="color: var(--gray); font-size: 0.9rem;">Navigate to the "Inventory" tab to
                                        add, edit, or delete products and update stock levels.</p>
                                </div>
                                <div class="faq-item" style="margin-bottom: 1rem;">
                                    <h5 style="font-weight: 700; margin-bottom: 0.5rem;">How do I track my revenue?</h5>
                                    <p style="color: var(--gray); font-size: 0.9rem;">The "Revenue" tab provides a
                                        detailed overview of your earnings across different time periods.</p>
                                </div>
                                <div class="faq-item" style="margin-bottom: 1rem;">
                                    <h5 style="font-weight: 700; margin-bottom: 0.5rem;">What are the benefits of
                                        Enterprise?</h5>
                                    <p style="color: var(--gray); font-size: 0.9rem;">Enterprise users get
                                        multi-location management, priority support, and advanced analytics.</p>
                                </div>
                            </div>
