    ...
    <main class="main-content">
        ...
        <div class="content">
            ...
            <div class="tab-content" id="inquiries-content">
                <div class="table-container">
                    <div class="table-header">
                        <h3 class="table-title">Contact Inquiries</h3>
                        <div class="table-filters">
                            <button class="filter-btn active">All</button>
                            <button class="filter-btn">Pending</button>
                                ...
                                <tr>
                                    <td>
                                        <div class="user-cell">
                                            ...
                                            <div class="user-details">
                                                <div class="user-name-td">{{ $msg->name }}</div>
                                    ...
                                    <td>{{ \Carbon\Carbon::parse($msg->created_at)->format('M d, Y') }}</td>
                                    <td>
                                        <div class="table-actions">
                                            <button class="icon-btn view" title="View Details">👁</button>
                                            <button class="icon-btn edit" title="Update Status">✏️</button>
                                            <button class="icon-btn delete" title="Delete">🗑</button>
                                        </div>
                                    </td>
                                </tr>
