        ...
        <div class="hero-content">
            <div class="hero-text">
                ...
                <p class="hero-description">
                    Discover local news, shop from nearby businesses, and grow your enterprise—all in one vibrant
                    marketplace tailored to your neighborhood.
                </p>
            ...
            <div class="hero-image">
                <img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&h=600&fit=crop"
                    alt="Local marketplace" class="hero-img">
    ...
    <section id="team">
        ...
        <div class="team-grid">
            ...
            <div class="team-card">
                ...
                <p class="team-bio">Passionate about building technology that brings communities together and empowers
                    local businesses.</p>
                <div class="team-social">
                    ...
                    <a href="https://github.com/project90029-sketch/Community_Sharing.git" class="social-link github"
                        aria-label="GitHub">
                        <svg class="social-icon" viewBox="0 0 24 24">
                            <path
            ...
            <div class="team-card">
                ...
                <p class="team-bio">Dedicated to creating user experiences that make community engagement effortless and
                    enjoyable.</p>
                <div class="team-social">
                    <a href="#" class="social-link linkedin" aria-label="LinkedIn">
                        <svg class="social-icon" viewBox="0 0 24 24">
            ...
            <div class="team-card">
                ...
                <p class="team-bio">Building bridges between neighbors and ensuring every voice in our community is
                    heard.</p>
                <div class="team-social">
                    <a href="#" class="social-link linkedin" aria-label="LinkedIn">
                        <svg class="social-icon" viewBox="0 0 24 24">
            ...
            <div class="team-card">
                ...
                <p class="team-bio">Spreading the word about LocalHub and helping communities discover the power of
                    connection.</p>
                <div class="team-social">
                    <a href="#" class="social-link linkedin" aria-label="LinkedIn">
                        <svg class="social-icon" viewBox="0 0 24 24">
